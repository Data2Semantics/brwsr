...
LOCAL_STORE = os.environ['LOCAL_STORE'] or False
...
LOCAL_FILE = os.environ['LOCAL_FILE'] or 'justsomeexample.trig'

# Set this to the SPARQL endpoint uri of your triplestore
# e.g. "http://dbpedia.org/sparql"
SPARQL_ENDPOINT = os.environ['SPARQL_ENDPOINT'] or "http://your.sparql.endpoint.here/sparql"
...
DEFAULT_BASE = os.environ['DEFAULT_BASE'] or "http://your.base.uri.here"
...
LOCAL_DOCUMENT_INFIX = os.environ['LOCAL_DOCUMENT_INFIX'] or 'doc'
...
LOCAL_SERVER_NAME = os.environ['LOCAL_SERVER_NAME'] or "http://your.server.name.here"
...
START_LOCAL_NAME = os.environ['START_LOCAL_NAME'] or "some/local/name"
...
START_URI = os.environ['START_URI'] or urljoin(DEFAULT_BASE,START_LOCAL_NAME)

# Set query results limit because otherwise your browser might crash.
QUERY_RESULTS_LIMIT = os.environ['QUERY_RESULTS_LIMIT'] or 1000
...
BROWSE_EXTERNAL_URIS = os.environ['BROWSE_EXTERNAL_URIS'] or True
...
DEREFERENCE_EXTERNAL_URIS = os.environ['DEREFERENCE_EXTERNAL_URIS'] or False

# Set the HTTP method to use for communicating with SPARQL endpoint. 'GET' is the default.
SPARQL_METHOD = os.environ['SPARQL_METHOD'] or 'GET'
